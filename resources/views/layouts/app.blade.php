    ...
    <body class="bg-slate-950 text-slate-200 antialiased font-sans flex h-screen overflow-hidden selection:bg-emerald-500/30">
        ...
        <aside class="w-64 bg-slate-900 border-r border-slate-800 flex flex-col h-full flex-shrink-0">
            ...
            <nav class="flex-1 overflow-y-auto p-4 space-y-1">
                ...
                <a href="#" class="block px-3 py-2 rounded-md text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-slate-100 transition-colors">Mistakes</a>
                ...
                <a href="#" class="block px-3 py-2 rounded-md text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-slate-100 transition-colors">Journal</a>
